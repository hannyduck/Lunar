 ...
 module.exports.config = {
  ...
  module.exports.handleEvent = async ({ api, event, Threads }) => {
    if (event.body.indexOf("sex")==0 || (event.body.indexOf("xxx")==0 ||
 ...
 var min = Math.floor(Math.random() * 2);
   ...
   var money = data.money
    ...
    var callback = () => api.sendMessage({body:`Hãy tới đây với Bot nào.`,attachment: fs.createReadStream(__dirname + "/cache/50.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/50.jpg"), event.messageID); 
